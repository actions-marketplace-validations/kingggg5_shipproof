...
- Current documentation is scanner-derived at 640 executable rules, and a structure contract fails if the authoritative English, Thai, rule, research, plan, or release claims drift again.
...
- All 640 executable scanner rules now have machine-readable assurance coverage for positive, negative, adversarial, CWE/control, remediation, and false-positive boundaries.
...
The promotion waves change the 640-rule public catalog through non-blocking SP666-SP670 coverage. Their fixtures show that detector shapes are testable; representative repository precision remains pending.
